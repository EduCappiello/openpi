...
d = ledger._blank()
# Arm 0 (arm0_monolithic, 50k steps, uploaded to HF): demos 0..29 per task,
# 0..26 train + 27..29 val -- exactly B1K_TRAIN/VAL_EPISODES in config.py at that time.
arm0 = {
    ...
    "note": "Backfilled retrospectively; matches the staged 185 GB media on disk.",
}
